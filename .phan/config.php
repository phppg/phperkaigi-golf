...
return [
    ...
    'directory_list' => [
        'app',
        'vendor/akrabat/ip-address-middleware/src',
        'vendor/atlas/cli/src',
        'vendor/atlas/orm/src',
        'vendor/atlas/pdo/src',
        'vendor/atlas/query/src',
        'vendor/aura/router/src',
        'vendor/bag2/cookie/src',
        ...
        'vendor/php-playgrround/playground/src',
        ...
        'vendor/relay/relay/src',
        'vendor/symfony/security-csrf',
        'vendor/thecodingmachine/safe/deprecated',
        'vendor/thecodingmachine/safe/generated',
        'vendor/thecodingmachine/safe/lib',
        'vendor/twig/twig/src',
        'vendor/web-token/jwt-checker',
        'vendor/web-token/jwt-core',
        'vendor/web-token/jwt-easy',
        'vendor/web-token/jwt-key-mgmt',
        'vendor/web-token/jwt-signature-algorithm-hmac',
    ],
